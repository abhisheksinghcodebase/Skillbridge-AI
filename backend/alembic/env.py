...
# Use SQLite for migration generation if PostgreSQL is not available
database_url = settings.DATABASE_URL
if database_url.startswith("postgresql"):
    # Try PostgreSQL, fallback to SQLite for local development
    import os
    if not os.getenv("ALEMBIC_USE_POSTGRES"):
